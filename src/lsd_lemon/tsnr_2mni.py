...
base_dir = '/nobackup/ilz2/julia_2mni/working_dir_mean/'
...
# select files
templates={'tsnr': '{subject_id}/preprocessed/lsd_resting/{scan}/realign/*mean.nii.gz',
...
mni.connect([(selectfiles, applywarp, [('tsnr', 'in_file'),
