...
base_dir = '/nobackup/ilz3/julia_2mni/working_dir_masks/'
...
# select files
templates={#'mask': '{subject_id}/preprocessed/anat/T1_brain_mask.nii.gz',
           'mask' : '{subject_id}/preprocessed/anat/T1_brain.nii.gz',
...
mni.connect([(selectfiles, applytransform, [('mask', 'input_image')]),
