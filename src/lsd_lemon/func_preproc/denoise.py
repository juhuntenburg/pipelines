...
#                      ])
    ...
    denoise.connect([(inputnode, filter1, [('epi_coreg', 'in_file')]),
                    ...
                    (inputnode, filter1, [(('mc_regressor', list_to_filename), 'design')]),
                    (inputnode, outputnode, [('mc_regressor', 'mc_regressor')]),
...
#                      (inputnode, createfilter2, [('wmcsf_mask','mask_file')]),
...
#                      ])
    ...
    denoise.connect([(filter1, filter2, [('out_res', 'in_file')]),
                     (inputnode, filter2, [('comp_regressor', 'design'),
                                           ('brain_mask_resamp', 'mask')]),
                     (inputnode, outputnode, [('comp_regressor', 'comp_regressor'), 
                                              ('brain_mask_resamp', 'brain_mask_resamp')]),
    ...
    denoise.connect([(bandpass_filter, outputnode, [('out_file', 'bandpassed_file')])
                     ])
